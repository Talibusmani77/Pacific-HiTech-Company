...
export const officeContacts = {
    saudi: {
        nameEn: "Saudi Arabia — Branch Office",
        nameAr: "المملكة العربية السعودية - مكتب الفرع",
        tel: "+966 56 172 7061",
    ...
    india: {
        nameEn: "India — Head Office",
        nameAr: "الهند - المكتب الرئيسي",
        tel: "+91 912 941 6070",
...
export const companyStats = [
    { label: "Projects Done", value: "473+" },
    { label: "Happy Clients", value: "361+" },
    { label: "Country Coverage", value: "12+" },
];
...
export const whyChooseUs = [
    {
        ...
        description: "We serve corporations across the Middle East and India with proven expertise.",
        icon: "Globe"
    },
    {
        id: 2,
        title: "On-Time Delivery",
        description: "Proven record meeting critical deadlines without compromising quality.",
        icon: "Clock"
    },
    {
        id: 3,
        title: "Customer Support",
        description: "24/7 support for projects and delivery, ensuring seamless communication.",
        icon: "Headphones"
    }
];
